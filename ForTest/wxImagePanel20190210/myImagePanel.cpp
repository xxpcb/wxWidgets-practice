/***************************************************************
* Name:      imagepanel.cpp------->(myImagePanel.cpp)
...
#include "myImagePanel.h"//#include "imagepanel.h"
...
wxImagePanel::wxImagePanel() : wxScrolledWindow()//wxPanel()
{
	Init();
}
...
wxImagePanel::wxImagePanel(wxWindow *parent,
	...
	wxScrolledWindow(parent, winid, pos, size, style, name)//wxPanel(parent, winid, pos, size, style, name)
{
	Init();
}
...
wxImagePanel::wxImagePanel(wxWindow *parent,
	...
	wxScrolledWindow(parent)//wxPanel(parent)
{
	Init();
